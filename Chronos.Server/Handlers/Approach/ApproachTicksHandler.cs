...
namespace Chronos.Server.Handlers.Approach
{
    ...
    {
        [HeaderPacket(HeaderEnum.QUERYTICKCOUNT)]
        public static void HandleQueryTickCountMessage(SimpleClient client, QueryTickCountMessage message)
        {
            SendTickCountMessage(client);
        }
